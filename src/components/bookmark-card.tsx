...
import { addUrlProtocol, getDomain, isValidFaviconUrl } from "../lib/utils";
...
export const BookmarkCard = memo(function BookmarkCard({
	...
	const { url, title, favicon: dbFavicon, createdAt, category, description } = bookmark;
	...
	const favicon = dbFavicon ?? `https://favicone.com/${domain}?s=32`;

	// Validate favicon URL - only use if safe (https or data:image)
	const safeFavicon = favicon && isValidFaviconUrl(favicon) ? favicon : undefined;
